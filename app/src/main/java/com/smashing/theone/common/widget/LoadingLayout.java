...
/**
 * author: chensen
 * date: 2017年03月29日10:55
 * desc: 用于切换不同的视图 （加载中，空数据，加载失败，网络错误）
 * 来自开源项目 https://github.com/weavey/LoadingLayoutDemo
 */
...
public class LoadingLayout extends FrameLayout {
    ...
    private void build() {
        ...
        errorPage.setBackgroundColor(getResources().getColor(backgroundColor));
        emptyPage.setBackgroundColor(getResources().getColor(backgroundColor));
        networkPage.setBackgroundColor(getResources().getColor(backgroundColor));
        ...
        errorText.setTextColor(getResources().getColor(tipTextColor));
        emptyText.setTextColor(getResources().getColor(tipTextColor));
        networkText.setTextColor(getResources().getColor(tipTextColor));
        ...
        errorReloadBtn.setTextColor(getResources().getColor(buttonTextColor));
        networkReloadBtn.setTextColor(getResources().getColor(buttonTextColor));
        ...
        switch (status) {
            case Success:
                ...
                if (defineLoadingPage != null) {
                    ...
                    defineLoadingPage.setVisibility(View.INVISIBLE);

                } else {

                    //！！！！ 注意 ：此处是自己定义的加载布局，里面用到了AnimationDrawable，若是其他的布局话要把下面两行代码删除
                    ImageView ivAnim = (ImageView) loadingPage.findViewById(R.id.iv_anim);
            ...
            case Loading:
                ...
                if (defineLoadingPage != null) {
                    ...
                    //！！！！ 注意 ：此处是自己定义的加载布局，里面用到了AnimationDrawable，若是其他的布局话要把下面两行代码删除
                    ImageView ivAnim = (ImageView) defineLoadingPage.findViewById(R.id.iv_anim);
    ...
    public LoadingLayout setReloadButtonTextColor(@ColorRes int id) {
        ...
        errorReloadBtn.setTextColor(getResources().getColor(id));
        networkReloadBtn.setTextSize(getResources().getColor(id));
        return this;
    }
